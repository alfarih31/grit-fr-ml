...
parser.add_argument("--devkit", default=False, type=str2bool,
                    help="Dataset type")
...
parser.add_argument('--step_size', default=50, type=int,
                    help='step_size value for StepLR Scheduler.')
...
if args.devkit:
    _VOCDataset = VOCDevkit
else:
    _VOCDataset = VOCDataset
...
if __name__ == '__main__':
    ...
    for epoch in range(last_epoch + 1, args.num_epochs):
        ...
        if epoch % args.validation_epochs == 0 or epoch == args.num_epochs - 1:
            ...
            model_path = os.path.join(args.checkpoint_folder, f"FPN-{epoch}-{val_loss:.3f}.pth")
            net.save(model_path)
